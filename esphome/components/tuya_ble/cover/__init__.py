    ...
    cover.COVER_SCHEMA.extend(
        {
            ...
            cv.Optional(CONF_STATE_DP): cv.uint8_t,
            cv.Optional(CONF_POSITION_DP): cv.uint8_t,
            cv.Optional(CONF_POSITION_SET_DP): cv.uint8_t,
